...
public abstract class DefaultJsonConfig {
    ...
    public static Map<String, GemType> getDefaultGemTypes() {
        ...
        map.put("obsidian_damage", new GemType("socketed.tooltip.default.obsidian_damage", TextFormatting.DARK_PURPLE,
                Collections.singletonList(new AttributeGemEffect(EnumSlots.HAND, SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new RandomValueRange(3,false), 0)),
        ...
        map.put("stone_damage", new GemType("socketed.tooltip.default.stone_damage", TextFormatting.GRAY,
                Collections.singletonList(new AttributeGemEffect(EnumSlots.HAND, SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new RandomValueRange(1,false), 0)),
                Arrays.asList(
                        new OreEntry("stone"),
                        new OreEntry("cobblestone")),1));

        map.put("sticky", new GemType("socketed.tooltip.default.sticky", TextFormatting.DARK_GREEN,
                Collections.singletonList(new PotionGemEffect(EnumSlots.BODY,
        ...
        map.put("lucky", new GemType("socketed.tooltip.default.lucky", TextFormatting.GREEN,
                Collections.singletonList(new AttributeGemEffect(EnumSlots.ALL, SharedMonsterAttributes.LUCK.getName(), new RandomValueRange(2,false), 0)),
        ...
        map.put("streamlined", new GemType("socketed.tooltip.default.streamlined", TextFormatting.AQUA,
                Collections.singletonList(new AttributeGemEffect(EnumSlots.BODY, EntityLivingBase.SWIM_SPEED.getName(), new RandomValueRange(0.1F,false), 1)),
        ...
        map.put("diamond", new GemType("socketed.tooltip.default.diamond", TextFormatting.AQUA,
                Arrays.asList(
                        new AttributeGemEffect(EnumSlots.HAND,/*"diamond_damage",*/ SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new RandomValueRange(2,3, true), 0),
                        new AttributeGemEffect(EnumSlots.BODY,/*"diamond_defense",*/ SharedMonsterAttributes.ARMOR.getName(), new RandomValueRange(2,false), 0)),
        ...
        map.put("redstone", new GemType("socketed.tooltip.default.redstone", TextFormatting.RED,
                Arrays.asList(
                        new AttributeGemEffect(EnumSlots.HAND, SharedMonsterAttributes.ATTACK_SPEED.getName(), new RandomValueRange(0.05F,false), 1),
                        new AttributeGemEffect(EnumSlots.BODY, SharedMonsterAttributes.MOVEMENT_SPEED.getName(), new RandomValueRange(0.05F,false), 1)),
        ...
        map.put("lapis", new GemType("socketed.tooltip.default.lapis", TextFormatting.BLUE,
                Collections.singletonList(new AttributeGemEffect(EnumSlots.ALL, "socketed.attributes.enchantingpower", new RandomValueRange(2,false), 0)),
        ...
        map.put("glowstone", new GemType("socketed.tooltip.default.glowstone", TextFormatting.YELLOW,
                Collections.singletonList(new PotionGemEffect(EnumSlots.HEAD, MobEffects.GLOWING.getRegistryName().toString(), 0, 60,EnumActivationType.PASSIVE_FAR)),
    ...
    public static Map<String, GemCombinationType> getDefaultGemCombinations() {
        ...
        map.put("three_diamonds", new GemCombinationType("socketed.tooltip.default.three_diamonds", TextFormatting.DARK_BLUE,
                Collections.singletonList(new AttributeGemEffect(EnumSlots.HAND, SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new RandomValueRange(8,false), 0)),
                false,false, true,
                Arrays.asList("diamond", "diamond", "diamond")));

        map.put("rgb", new GemCombinationType("socketed.tooltip.default.rgb", TextFormatting.GOLD,
                Arrays.asList(
                        new PotionGemEffect(EnumSlots.ALL, MobEffects.GLOWING.getRegistryName().toString(), 0, 60, EnumActivationType.PASSIVE_SELF),
                        new PotionGemEffect(EnumSlots.ALL, MobEffects.GLOWING.getRegistryName().toString(), 0, 60, EnumActivationType.PASSIVE_NEARBY)),
                true,true, false,

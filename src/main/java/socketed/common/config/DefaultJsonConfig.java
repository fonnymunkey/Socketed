...
public abstract class DefaultJsonConfig {
    ...
    private static final List<GenericTarget> ONLYSELF = Collections.singletonList(new SelfTarget(null));
    private static final List<GenericTarget> ONLYOTHER = Collections.singletonList(new OtherTarget(null));
    ...
    public static void initializeBuiltinEntries() {
        ...
        registerDefaultGemType("flint", new GemType(
                "socketed.tooltip.default.flint",
                1,
                TextFormatting.AQUA,
        ...
        registerDefaultGemType("quartz", new GemType(
                "socketed.tooltip.default.quartz",
                2,
                TextFormatting.WHITE,
        ...
        registerDefaultGemType("emeraldblock", new GemType(
                "socketed.tooltip.default.emeraldblock",
                2,
                TextFormatting.GREEN,
        ...
        registerDefaultGemType("beacon", new GemType(
                ...
                Arrays.asList(
                        new MultiEffectGemEffect(SocketedSlotTypes.HEAD, new PassiveActivator(new LightLevelCondition(15, ComparingCondition.ConditionComparisonType.EQUAL, true), 9), Collections.singletonList(new SelfTarget(null)), Arrays.asList(
                                new PotionGemEffect(SocketedSlotTypes.ALL, new MultiEffectActivator(null), Collections.singletonList(new SelfAOETarget(null, 32)), MobEffects.INVISIBILITY.getRegistryName().toString(), 0, 10),
                                new PotionGemEffect(SocketedSlotTypes.ALL, new MultiEffectActivator(null), Collections.singletonList(new SelfAOETarget(null, 32)), MobEffects.GLOWING.getRegistryName().toString(), 0, 10)
                        )),
        ...
        registerDefaultGemType("skullzombie", new GemType(
                "socketed.tooltip.default.skullzombie",
                3,
                TextFormatting.DARK_GREEN,
        ...
        registerDefaultGemType("skullcreeper", new GemType(
                "socketed.tooltip.default.skullcreeper",
                3,
                TextFormatting.GREEN,
                Collections.singletonList(new RemoveTargetGemEffect(
                        SocketedSlotTypes.BODY,
        ...
        registerDefaultGemType("skullskeleton", new GemType(
                "socketed.tooltip.default.skullskeleton",
                3,
                TextFormatting.WHITE,
                Collections.singletonList(new RemoveTargetGemEffect(
                        SocketedSlotTypes.BODY,

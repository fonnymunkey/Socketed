...
public class DefaultSocketsGenerator {
    ...
    public static void addSockets(ItemStack stack, IItemCreationContext context) {
        ...
        int rollAmount = DefaultSocketsGenerator.getRollAmount(stack);
        float rollChance = DefaultSocketsGenerator.getRollChance(stack);

        DefaultSocketsGenerator.addSocketsRandomly(stack, context.getMaxSockets(), rollAmount, rollChance);
    }
    ...
    public static void addSocketsRandomly(ItemStack stack, int maxSockets, int rollAmount, float rollChance) {
        ...
        for(int i = 0; i < rollAmount; i++) {
            ...
            if(RAND.nextFloat() <= rollChance) {
                ...
                itemSockets.addSocket(new TieredSocket(DefaultSocketsGenerator.getRandomTierForSocket()));
            }
        }
    }
    ...
    public enum SocketedItemCreationContext implements IItemCreationContext {
